...
| `scripts/build_website.sh` | Syncs `obsidian/` → `website/content/` (People/, Places/, attachments/) and runs Quartz build |
...
rm -rf website/content/People website/content/attachments website/content/Places
rsync -a obsidian/People/ website/content/People/
rsync -a obsidian/attachments/ website/content/attachments/
rsync -a obsidian/Places/ website/content/Places/
